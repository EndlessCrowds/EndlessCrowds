...
Currently refactoring my crowdfunding ventures for a 2026 relaunch. My goal is to deploy a Monorepo architecture that powers both the web and native mobile apps.

I'm also building the **Agent Proof Protocol**, trying to solve the problem of trust between human crowds and AI agents.

I'm here to build, learn, and connect.
...
![Google Antigravity](https://img.shields.io/badge/IDE-Google%20Antigravity-blue?style=for-the-badge&logo=google)
![TurboRepo](https://img.shields.io/badge/Monorepo-TurboRepo-red?style=for-the-badge&logo=turborepo)
